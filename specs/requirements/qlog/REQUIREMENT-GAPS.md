...
- `source-provenance-refresh` remains open. The main-schema parity refresh compared against the QUICWG latest preview, but the local source manifest and text snapshot still intentionally point at `draft-ietf-quic-qlog-main-schema-13`.
...
- `main-schema-latest-guidance-review` is resolved by `REQ-QLOG-MAIN-S1P2-0001`, `REQ-QLOG-MAIN-S3P1-0001`, `REQ-QLOG-MAIN-S8P3-0001`, `REQ-QLOG-MAIN-S9-0002`, `REQ-QLOG-MAIN-S9-0003`, `REQ-QLOG-MAIN-S10-0001`, `REQ-QLOG-MAIN-S11P1-0002`, `REQ-QLOG-MAIN-S11P3-0001`, `REQ-QLOG-MAIN-S12P1-0001`, `REQ-QLOG-MAIN-S13-0001`, and `REQ-QLOG-MAIN-S14-0001`. The remaining official main-schema guidance identified during the latest-preview review is now represented in SpecTrace rather than being an implicit backlog.
...
- `qlogdir-file-output-selection` is resolved by `REQ-QLOG-MAIN-S12P1-0001`. The file sinks now honor `QLOGDIR` for relative qlog file names, with `QLOGFILE` as an optional fallback when the directory variable is not set.
- `event-importance-schema-surface` is resolved by `REQ-QLOG-MAIN-S8P3-0001`. The core and QUIC schema catalogs now preserve the authored event importance metadata recorded in the draft sources.
- `capture-control-policy-surface` is resolved by `REQ-QLOG-MAIN-S14-0001`. The internal capture session now requires an explicit start action before qlog data can be written.
...
- `import-package-boundary` is resolved by [`SPEC-QLOG-IMPORT.json`](SPEC-QLOG-IMPORT.json), `REQ-QLOG-IMPORT-S1-0001`, `REQ-QLOG-IMPORT-S1-0002`, `REQ-QLOG-IMPORT-S1-0003`, `REQ-QLOG-IMPORT-S1-0004`, `REQ-QLOG-IMPORT-S1-0005`, and `REQ-QLOG-IMPORT-S1-0006`. The replay-oriented hydration surface now ships in the sibling `Incursa.Qlog.Import` package and covers contained JSON, sequential JSON Text Sequences, and contained CBOR import without moving parser dependencies into `Incursa.Qlog` core.
