...
- `main-schema-planned-surfaces` remains open for `REQ-QLOG-MAIN-S8P3-0001` and `REQ-QLOG-MAIN-S14-0001`. Event-importance metadata and explicit capture-control policy are now requirements, but the production surfaces are still planned.
