...
- `json-seq-first-class` has been resolved by the sequential JSON Text Sequences serializer boundary. Keep future adjustments aligned with the draft requirements and the existing contained JSON writer separation.
